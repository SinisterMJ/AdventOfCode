#ifndef ADVENTOFCODE2019_DAY24
#define ADVENTOFCODE2019_DAY24
...
private:
	...
	int64_t calcSecond()
	{
		...
		for (uint64_t y = 0; y < inputVector.size(); ++y)
		{
			for (uint64_t x = 0; x < inputVector[y].length(); ++x)
			{
