#ifndef ADVENTOFCODE2016_DAY24
#define ADVENTOFCODE2016_DAY24
...
public:
	Day24()
	{
		inputString = util::readFile("..\\inputs\\2016\\input_24.txt");
		inputVector = util::readFileLines("..\\inputs\\2016\\input_24.txt");
	}
