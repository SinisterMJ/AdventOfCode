#ifndef ADVENTOFCODE2016_DAY18
#define ADVENTOFCODE2016_DAY18
...
public:
	Day18()
	{
		inputString = util::readFile("..\\inputs\\2016\\input_18.txt");
		inputVector = util::readFileLines("..\\inputs\\2016\\input_18.txt");
	}
