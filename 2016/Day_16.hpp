#ifndef ADVENTOFCODE2016_DAY16
#define ADVENTOFCODE2016_DAY16
...
public:
	Day16()
	{
		inputString = util::readFile("..\\inputs\\2016\\input_16.txt");
		inputLines = util::readFileLines("..\\inputs\\2016\\input_16.txt");
	}
