#ifndef ADVENTOFCODE2015_DAY18
#define ADVENTOFCODE2015_DAY18
...
public:
	Day18()
	{
		inputString = util::readFile("..\\inputs\\2015\\input_18.txt");
		inputVector = util::readFileLines("..\\inputs\\2015\\input_18.txt");
	}
