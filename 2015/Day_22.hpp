...
public:
	Day22()
	{
		inputString = util::readFile("..\\inputs\\2015\\input_22.txt");
		inputVector = util::readFileLines("..\\inputs\\2015\\input_22.txt");
	}
	...
	int64_t run()
	{
		...
		int64_t result1 = calcFirstDeck(10007, inputVector, 2015);
